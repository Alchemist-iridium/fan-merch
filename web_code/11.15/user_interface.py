...
import datetime
from main import db, User, Artist, Customer, Artwork, Product, ArtworkApprovalAdmin, OrderManagementAdmin, SuperAdmin, create_user
import os
    ...
    if request.method == 'POST':
        ...
        if user and check_password_hash(user.password_hash, password):
            ...
            if user.role == 'artwork_approval_admin':
                return redirect(url_for('artwork_approval_admin_dashboard'))
            elif user.role == 'order_management_admin':
                return redirect(url_for('order_management_admin_dashboard'))
...
@app.route('/artwork_approval_admin_dashboard', methods=['GET', 'POST'])
...
@app.route('/order_management_admin_dashboard', methods=['GET', 'POST'])
...
@app.route('/public_search', methods=['GET', 'POST'], endpoint='public_search')
def public_search():
    search_results = []
...
@app.route('/admin_assign_product/<int:product_id>', methods=['POST'])
