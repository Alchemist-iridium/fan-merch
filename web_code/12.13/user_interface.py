...
@user_interface.route('/admin_login', methods=['GET', 'POST'])
def admin_login():
    if request.method == 'POST':
        email = request.form['email']
        password = request.form['password']
        ...
        if admin and check_password_hash(admin.password_hash, password):
            ...
            return render_template('account/admin_login.html', error=error)
...
def view_notifications():
    ...
    return render_template('unread_notifications.html', categorized_notifications=categorized_notifications)
...
def view_read_notifications():
    ...
    return render_template('read_notifications.html', categorized_notifications=categorized_notifications)
