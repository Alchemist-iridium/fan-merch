...
class ItemOrderItem(db.Model):
    ...
    id = db.Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)  # Unique identifier for each item in the order
    ...
    item_status = db.Column(db.String(50), default="item")  # Tracks the current stage:"item", "refunded","transferred","delivered", "abandoned"
