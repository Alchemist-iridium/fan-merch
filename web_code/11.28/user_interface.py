...
from models import User, Artist, Customer, Artwork, Product,ProductionRound, Order,Dialog, ArtworkApprovalAdmin, OrderManagementAdmin, ProductApprovalAdmin, DesignFile, Notification
...
def view_cart():
    ...
    if request.method == 'POST':
        # Proceed to checkout: Confirm all items in the cart
    ...
    return render_template('view_cart.html', cart_orders=cart_orders)
...
def artist_dashboard():
    ...
    return render_template('artist_dashboard.html', artist=artist, artworks=artworks, products=products, unread_notifications_count=unread_notifications_count)
...
def order_management_admin_dashboard():
    ...
    return render_template('order_management_admin_dashboard.html', products=products, production_rounds=production_rounds,unread_notifications_count=unread_notifications_count)
