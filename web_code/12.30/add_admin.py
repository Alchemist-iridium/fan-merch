# add_admin.py
from main import db
from app.models import ArtworkApprovalAdmin, OrderManagementAdmin, ProductApprovalAdmin
...
if __name__ == '__main__':
    ...
    role = input("Enter the role for the new admin (artwork_approval_admin, order_management_admin, product_approval_admin): ").strip().lower()
