...
def artwork_approval_admin_dashboard():
    ...
    if request.method == 'POST':
        ...
        if 'approve_id' in request.form:
            ...
            if artwork_id and artwork_id.isdigit():
                ...
                if artwork and artwork.approval_status == 'Pending':
                    ...
                    return redirect(url_for('user_interface.artwork_approval_admin_dashboard'))
            else:
        ...
        # Handle artwork disapproval by redirecting to the disapproval page
            ...
            # Redirect to the detailed disapproval page
            if artwork_id and artwork_id.isdigit():
                return redirect(url_for('user_interface.disapprove_artwork', artwork_id=artwork_id))
