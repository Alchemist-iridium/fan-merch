    ...
    if request.method == 'POST':
        ...
        if admin and check_password_hash(admin.password_hash, password):
            ...
            if admin.role == 'artwork_approval_admin':
                ...
                return redirect(url_for('admin.warehouse_admin_dashboard'))
            elif admin.role == 'delivery_admin':
                return redirect(url_for('admin.delivery_admin_dashboard'))
        else:
...
def delete_warehouse_record(record_id):
    ...
    return redirect(url_for('admin.manage_warehouse_record', production_round_id=warehouse_record.production_round_id))
